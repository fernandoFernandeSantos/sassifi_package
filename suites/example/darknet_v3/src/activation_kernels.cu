...
__global__ void binary_gradient_array_kernel(float *x, float *dy, int n,
		int s, BINARY_ACTIVATION a, float *dx) {
...
extern "C" void binary_gradient_array_gpu(float *x, float *dx, int n,
		int size, BINARY_ACTIVATION a, float *y, cudaStream_t st) {
...
extern "C" void binary_activate_array_gpu(float *x, int n, int size,
		BINARY_ACTIVATION a, float *y, cudaStream_t st) {
...
extern "C" void gradient_array_gpu(float *x, int n, ACTIVATION a,
		float *delta, cudaStream_t st) {
