...
void train_segmenter(char *datacfg, char *cfgfile, char *weightfile, int *gpus,
...
void demo_segmenter(char *datacfg, char *cfg, char *weights, int cam_index,
		const char *filename) {
#ifdef OPENCV
...
void run_segmenter(int argc, char **argv) {
	...
	if (0 == strcmp(argv[2], "test"))
		predict_segmenter(data, cfg, weights, filename);
